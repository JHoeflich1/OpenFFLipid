...
#SBATCH --job-name={molecule}_{size}_prod1
#SBATCH --output={molecule}_{size}_prod1.%j.out
...
# NVT
gmx grompp -p {molecule}_{size}.top -f nvt2.mdp -c npt1_box_{molecule}_{size}.gro -o nvt2_{molecule}_{size}.tpr
gmx mdrun -deffnm nvt2_{molecule}_{size}
"""
...
for molecule in molecules:
    for size in sizes:
        ...
        job_filename = f"{molecule}_{size}_prod1.sh"
