...
# length_b = 3000  #before running, check how long you run npt for and only average last part of simulation for the average. 
# length_e = 6000  # the npt simulation was run for 10 ns, average last 5 nm, probably dont need to run that long next time
...
# molecules = ['water', 'hexane', 'heptane', 'octane', 'decane', 'pentadecane']
