...
def calculate_msd(params):
    ...
    for i in range(alkane_size):
        ...
        command = f"echo 0 | gmx msd -f nvt2_{alkane}_{alkane_size}.xtc -s nvt2_{alkane}_{alkane_size}.tpr -o msds/msd_{alkane}_{alkane_size}_{i}.xvg -n ndxs/ndxs_{alkane}_{alkane_size}_{i}.ndx -rmpbc -pbc"
        os.system(command)
